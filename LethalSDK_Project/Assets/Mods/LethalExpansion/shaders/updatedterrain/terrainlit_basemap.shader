Shader "Hidden/HDRP/UpdatedTerrainLit_Basemap"
{
    Properties
    {
    ...
    #include "Assets/Mods/LethalExpansion/shaders/updatedterrain/TerrainLit_Basemap_Includes.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Mods/LethalExpansion/shaders/updatedterrain/TerrainLit_Basemap.hlsl"
